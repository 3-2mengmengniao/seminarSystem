...
<div class="content">
    ...
    <div class="container">
        <div class="toggle-1">
            <a class="my-deploy-toggle-1" style="cursor:pointer" href='/teacher/course-seminar'>用例分析</a>
        </div>
    </div>
<div class="distance3">
    <div class="container">
        <div class="toggle-1">
            <a class="my-deploy-toggle-1" style="cursor:pointer" href='/teacher/course-seminar'>界面原型</a>
        </div>
    </div>
