            ...
            <div class="layui-colla-item">
                ...
                <div class="layui-colla-content">
                    ...
                    <#list round.seminarInfoList as seminar>
                        <div class="layui-colla-item">
                            <h2 class="layui-colla-title">第${seminar.seminarSerial}次&emsp;${seminar.seminarName}<img style="width: 20px;float: right;margin-top: 11px;" src="/images/修改.png" onclick="window.location.href='/teacher/course/seminar/setting?courseId=${course.id}&seminarId=${seminar.id}'"/></h2>
