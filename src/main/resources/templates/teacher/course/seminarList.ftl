            ...
            <div class="layui-colla-item">
                ...
                <div class="layui-colla-content">
                    ...
                    <#list round as seminar>
                        <div class="layui-colla-item">
                            <h2 class="layui-colla-title">${seminar?index+1}&emsp;${seminar.seminarName}<img style="width: 20px;float: right;margin-top: 11px;" src="/images/修改.png" onclick="window.location.href='/teacher/course/seminar/setting?seminarId=${seminar.id}'"/></h2>
