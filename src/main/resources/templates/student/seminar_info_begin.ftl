...
<div class="content">
    ...
    <table class="layui-table" lay-skin="nob">
        ...
        <tr>
            <td>课程情况</td>
            <td>正在进行 <a href="/student/enrollment?courseId=${course.id}&classId=${classId}&seminarId=${seminarInfo.id}" style="display: inline;margin-left: 20px;color:#009688;">查看信息</a></td>
        </tr>
        </tbody>
    </table>
    <div class="distance4"></div>
