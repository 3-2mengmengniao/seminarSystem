        ...
        <div class="layui-collapse" lay-accordion="">
            <div class="layui-colla-item">
                ...
                <div class="layui-colla-content">
                    ...
                    <a class="my-navigation layui-anim layui-anim-fadein"  href="/student/course/grade?courseId=${course.getId()}">我的成绩</a>
                </div>
                <div class="layui-colla-content">
                    <i class="layui-icon layui-icon-group layui-anim layui-anim-fadein"></i>
                    <a class="my-navigation layui-anim layui-anim-fadein" href="/student/course/teams?courseId=${course.getId()}">我的组队</a>
                </div>
                <div class="layui-colla-content">
