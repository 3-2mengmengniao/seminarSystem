...
<div class="content">
    ...
    <table class="layui-table" lay-skin="nob">
        ...
        <tr>
            <td>课程情况</td>
            <td>正在进行 <a href="/student/course/seminar/enrollment?courseId=${course.id}&seminarId=${seminarInfo.id}&classId=${classId}" style="display: inline;margin-left: 20px;color:#009688;">查看信息</a></td>
        </tr>
        </tbody>
    </table>
    <div class="distance4"></div>
