...
<div class="content">
    ...
    <div class="center-navigation">
        <table class="layui-table" lay-skin="nob">
            ...
            <tr>
                <td>课程情况</td>
                <td>未开始<a href="/student/course/seminar/enrollment?courseId=${course.id}&seminarId=${seminarInfo.id}&classId=${classId}" style="display: inline;margin-left: 20px;color:#009688;">查看信息</a></td>
            </tr>
            <tr>
                <td>报名开始时间</td>
