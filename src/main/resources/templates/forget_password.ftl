...
<div class="content">
    <div class="navigation-back">
        <h1 class="navigation-back">找回密码</h1>
    ...
    <form action="/vali_psw" method="post" class="contactForm" id="contactForm">
        <fieldset>
            ...
            <div class="formFieldWrap">
                <label class="field-title contactNameField" for="contactNameField">学号/教工号：<span>(required)</span></label>
            ...
            <div class="formValidationError" id="contactNameFieldError">
                <div class="static-notification-red tap-dismiss-notification">
                    <p class="center-text uppercase">请填写学号/教工号</p>
                </div>
            </div>
            ...
            <div class="formSubmitButtonErrorsWrap">
                <p class="center center-text "><input type="submit"  onclick="window.location.href='/new_password'" class="buttonWrap button button-dark button-big contactSubmitButton" id="contactSubmitButton" value="下一步" data-formId="contactForm"/>
                </p>
            </div>
            </p>
        </fieldset>
